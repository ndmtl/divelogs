...
Features
Create dive‑log cards with depth, duration, visibility, and more
Client‑side validation to ensure clean and consistent data

Upcoming
Local Storage persistence so logs stay saved between sessions
Simple, lightweight UI built with vanilla JavaScript
Integration of a forecast API to display weather and marine conditions for each dive
A Leaflet map using Leaflet.js to visualize all dive locations on an interactive map
Better UI/UX and more customization options for each log
